...
var ProblemListComponent = (function () {
    ...
    ProblemListComponent.prototype.getProblems = function () {
        var _this = this;
        this.subscriptionProblems = this.data.getProblems().subscribe(function (problems) { _this.problems = problems; });
    };
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__services_data_service__ = __webpack_require__(463);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__components_problem_detail_problem_detail_component__ = __webpack_require__(302);
...
var DataService = (function () {
    ...
    DataService.prototype.addProblem = function (problem) {
        ...
        return this.http.post('/api/v1/problems', problem, headers).toPromise()
            .then(function (res) {
            _this.getProblems();
            return res.json();
        })
